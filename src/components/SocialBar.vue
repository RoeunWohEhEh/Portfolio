<template>
  <div class="fixed left-8 bottom-0 hidden md:flex flex-col items-center gap-6 z-40 animate-fade-in">
    <a href="https://github.com/RoeunWohEhEh" target="_blank" rel="noopener noreferrer"
    ...
    <a href="https://www.facebook.com/share/1BnJ7iYCTh/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer"
      class="group flex items-center justify-center w-10 h-10 rounded-lg bg-slate-900/50 border border-white/5 text-gray-400 hover:text-brand-pink hover:border-brand-pink/30 hover:shadow-[0_0_15px_rgba(236,72,153,0.2)] transition-all duration-300">
      <i class="fab fa-facebook-f text-lg group-hover:scale-110 transition-transform"></i>
    </a>
    <div class="w-[2px] h-32 bg-gradient-to-t from-transparent via-white/10 to-white/10"></div>
  </div>
</template>
